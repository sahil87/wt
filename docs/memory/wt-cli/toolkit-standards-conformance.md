...
- Deferrals: `fab/backlog.md` — `[v7xy]` (`wt skill` adoption) **now resolved in `260717-v7xy`** and `[p5m9]` (`wt delete --dry-run`) **closed by `260717-p5m9`** (see [delete-dry-run-contract](/wt-cli/delete-dry-run-contract.md)); still open: `[ohwb]` (`wt delete` stdout→stderr realignment).
